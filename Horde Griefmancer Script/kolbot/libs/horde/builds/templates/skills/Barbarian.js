...
*	@author		Adpist
*	@desc		Barbarian skill builds :
*					"BOBarb" : Bo / Find item barb
*	@credits	Adpist, Mark, JeanMax / SiC-666 / Dark-f, Alogwe, Imba, Kolton, Larryw, Noah, QQValpen, Sam, YGM
*	
*/

var SkillsBuilds = {
	"BOBarb": [ // TODO make this only a shout barb
		[130, 1, false], //Howl
...
"Concentration" : [
    [126, 8, false], // Bash
    [127, 4, false], // Sword Mastery
    [130, 1], // Howl
    [138, 1], // Shout
    [131, 1], // Find Potion
    [142, 1, false], // Find Item
    [139, 1], // Stun
    [144, 8, false], // Concentrate
    [149, 5, false], // Battle Orders
    [132, 1], // Leap
